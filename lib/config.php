...
$dbuser = "zfh4";//your ucid since we follow this pattern
$dbpass = "KatrinaKaift!123";//database password generated or chosen per respective steps
$dbdatabase = "zfh4";//your ucid since we follow this pattern
?>
